...
export default async function IE_BOG_CreateDocument({ amount, iban, firstName, lastName }: { amount: number; iban: string; firstName: string; lastName: string }) {
  try {
    ...
    const transactionData = [
      {
        ...
        SourceAccountNumber: process.env.IE_BOG_SOURCE_ACCOUNT_NUMBER,
