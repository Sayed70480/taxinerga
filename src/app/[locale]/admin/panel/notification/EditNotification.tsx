...
const EditNotification = ({ defaultValue, defaultChecked }: { defaultValue?: { ka: string; ru: string; tk: string }; defaultChecked: boolean }) => {
  ...
  const handleSubmit = async () => {
    setLoading(true);
    try {
      await Admin_Axios.put("/notification", {
        content: {
